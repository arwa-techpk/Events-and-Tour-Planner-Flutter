...
class AddPlaceEventScreen extends StatefulWidget {
  int day;
  String selectedPlan;
  String city;
  AddPlaceEventScreen({this.day, this.selectedPlan, this.city});

  @override
  _AddPlaceEventScreenState createState() => _AddPlaceEventScreenState();
}

class _AddPlaceEventScreenState extends State<AddPlaceEventScreen> {
  @override
...
class __SignInFormState extends State<_SignInForm> {
  ...
  addPlan() {
    Utils.showLoader();
    firestoreInstance.collection('places').doc().set({
